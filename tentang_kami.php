...
<body>
    ...
    <div class="container-fluid banner-campaigns d-flex align-items-center ">
        <div class="container">
            <h1 class="text-white">Tentang Organisasi Kami</h1>
        </div>
    </div>
    ...
    <div class="containe-fluid py-5">
        <div class="container text-center fs-5">
            <p> Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse ea quae ab voluptatem illo quaerat eaque maxime voluptatum magnam. Vel, nisi ipsa. Deserunt laudantium itaque consequuntur deleniti repellendus, atque distinctio doloremque eveniet quibusdam. Odit autem ab, libero sit tempore et aut magni repellat consequatur consectetur delectus in ducimus recusandae veritatis est deserunt! Voluptatum quaerat aperiam libero illum a distinctio dolorem! Eius labore nemo maiores, fuga sequi nisi velit! Ab doloribus minima doloremque repellat vel, suscipit amet nihil voluptatem excepturi quia! Voluptates accusamus numquam necessitatibus. Itaque qui nam consequuntur, porro aspernatur quae, harum aperiam aut dolorem totam molestiae possimus numquam vitae ullam. Maiores iusto reprehenderit dolor expedita cupiditate vero nisi unde obcaecati veritatis tempora, ducimus beatae excepturi nostrum iure minus, porro necessitatibus omnis. Unde, sint iste architecto laboriosam expedita autem placeat, inventore reiciendis saepe id eveniet provident illum pariatur. Nostrum rerum atque minima et. Dolorem error necessitatibus alias accusamus dolorum nobis.
            </p>
            <p>
